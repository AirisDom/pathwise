...
function CardHeaderEnhanced({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  const { variant } = useCardContext();
  return <div data-slot="card-header" className={cn(cardHeaderVariants({ variant }), className)} {...props} />;
}

// CardContent Component
function CardContentEnhanced({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  const { variant } = useCardContext();
  return <div data-slot="card-content" className={cn(cardContentVariants({ variant }), className)} {...props} />;
}

// CardFooter Component
function CardFooterEnhanced({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  const { variant } = useCardContext();
...
function CardTitleEnhanced({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
...
function CardDescriptionEnhanced({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div data-slot="card-description" className={cn('text-sm text-muted-foreground', className)} {...props} />;
}

// Exports
export {
  CardEnhanced as Card,
  CardContentEnhanced as CardContent,
  CardDescriptionEnhanced as CardDescription,
  CardFooterEnhanced as CardFooter,
  CardHeaderEnhanced as CardHeader,
  CardHeading,
  CardTitleEnhanced as CardTitle,
  CardToolbar,
};
